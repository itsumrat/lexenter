                ...
                <div class="row">
                    <div class="col-12">
                    	...
                    	<div class="main-content article-list">
                            <a href="<?php echo e(route('term.create')); ?>" class="new-article-btn"><span class="material-icons">post_add</span>Create New Term</a>
                    		<table id="article-list" class="table" style="width:100%">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $termcontexts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $termc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td>
                                            <span class="term-group"><?php echo e($termc->ctermst); ?></span><br>
                                            <?php echo $termc->termcontext->cparagraph; ?>

                                        </td>
                                        <td>
                                            <span class="term-group"><?php echo e($termc->etermst); ?></span><br>
                                            <?php echo $termc->termcontext->eparagraph; ?>
                                        ...
                                        <td>
                                        	<div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                    <a href="<?php echo e(route('editTerm', $termc->id)); ?>"><span class="material-icons">create</span> Edit</a><br>
                                                    <a href="#" class="termDetails" data-id="<?php echo e($termc); ?>" data-toggle="modal" data-target="#term-info-modal"><i class="material-icons">view_headline</i> Details</a><br>
                                                    
                                                    <?php echo Form::open(['method' => 'POST','route' => ['deleteTerm', $termc->id],'style'=>'display:inline', 'class'=>'delete_form']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\others\lexenter\resources\views/modules/term/index.blade.php ENDPATH**/ ?>